# Add Variety to the quiz

import random
from string import ascii_lowercase

NUM_QUESTIONS_PER_QUIZ = 5 #  number of questions in the quiz
QUESTIONS = {
...
questions = random.sample(list(QUESTIONS.items()), k=num_questions) # randomize order of the questions
...
for num, (question, alternatives) in enumerate(questions, start=1):
 ...
 labeled_alternatives = dict(
  zip(ascii_lowercase, random.sample(alternatives, k=len(alternatives))) # randomize the order of your questions and the order of the answer alternatives
 )
